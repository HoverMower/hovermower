#ifndef _HOVERMOWER_SAFETYCONTROLLER_H
#define _HOVERMOWER_SAFETYCONTROLLER_H
...
class HoverMower_SafetyController : public rclcpp::Node
{
public:
    HoverMower_SafetyController(std::string name);
    ~HoverMower_SafetyController();
